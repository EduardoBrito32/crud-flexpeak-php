        ...
        <div  id="geraPDF" class="container">
            <div class="span10 offset1">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label font-weight-bold">Logradouro:</label>
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['logradouro'];?>
                            </label>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label font-weight-bold">Numero:</label>
                        <div class="controls">
                            <label class="carousel-inner">
                    ...
                    <div class="control-group">
                        <label class="control-label font-weight-bold">cidade:</label>
                        <div class="controls">
                            <label class="carousel-inner">
                    ...
                    <div class="control-group">
                        <label class="control-label font-weight-bold">Id do curso:</label>
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['id_curso'];?>
                            </label>
                        </div>
                    </div>
