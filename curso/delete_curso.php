    ...
    <body>
        <div class="container">
            <div class="span10 offset1">
                <div class="row">
                    <h3 class="well">Excluir Curso</h3>
                </div>
                <form class="form-horizontal" action="delete_curso.php" method="post">
                    <input type="hidden" name="id_curso" value="<?php echo $id;?>" />
                    <div class="alert alert-danger"> Deseja excluir o contato?
                    </div>
                    <div class="form actions">
                        <button type="submit" class="btn btn-danger">Sim</button>
                        <a href="index_curso.php" type="btn" class="btn btn-default">Não</a>
                    </div>
                </form>
            </div>
        </div>
